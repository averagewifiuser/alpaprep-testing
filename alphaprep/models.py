...
from alphaprep import db, login_manager, app
from flask_login import UserMixin # a class that has certain login functionalities and manages our sessions

# user loader, reloads user id stored in the session, it was in the documentation
