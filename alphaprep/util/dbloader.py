...
app.config['MYSQL_DATABASE_USER'] = os.environ['ALPHA_DB_USER']
app.config['MYSQL_DATABASE_PASSWORD'] = os.environ['ALPHA_DB_PASSWORD']
app.config['MYSQL_DATABASE_DB'] = os.environ['ALPHA_DB_NAME']
